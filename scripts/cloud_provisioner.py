...
def _build_parser() -> argparse.ArgumentParser:
    ...
    def add_common(p: argparse.ArgumentParser) -> None:
        ...
        p.add_argument("--azure-zone-label", default=os.environ.get("AZURE_ZONE_LABEL", "eastus2-1"))
        p.add_argument("--azure-vm-size", default=os.environ.get("AZURE_VM_SIZE", "Standard_DC2es_v6"))
